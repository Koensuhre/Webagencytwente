...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Website laten maken in Twente? Web Agency Twente ontwerpt en bouwt websites, webshops en SEO voor ondernemers in Enschede, Hengelo en Almelo. Vraag een gratis website scan aan." },
        ...
        children: JSON.stringify({
          ...
          hasOfferCatalog: {
            ...
            itemListElement: [
              ...
              "@type": "Offer",
              itemOffered: { "@type": "Service", name: service, areaServed: "Twente" },
            })),
          },
          address: {
            "@type": "PostalAddress",
