    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/webdesign-hengelo", changefreq: "monthly", priority: "0.8" },
          { path: "/website-laten-maken-twente", changefreq: "monthly", priority: "0.8" },
          { path: "/seo-specialist-enschede", changefreq: "monthly", priority: "0.8" },
